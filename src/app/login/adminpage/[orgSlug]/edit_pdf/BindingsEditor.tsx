...
export default function BindingsEditor({ schemas, bindings, assets, onChange }: Props) {
    ...
    return (
        <Box>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                ...
                volontøren sitt skjema med samme nøkkel.
            </Typography>
            {fieldNames.map((name) => (
                <BindingRow
                    key={name}
...
function BindingRow({ name, binding, assets, onChange }: BindingRowProps) {
